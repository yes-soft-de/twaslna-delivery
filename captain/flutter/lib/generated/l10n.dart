...
class S {
  ...
  /// `Welcome to twaslna_captain`
  String get welcomeTotwaslna_captain {
    return Intl.message(
      'Welcome to twaslna_captain',
      name: 'welcomeTotwaslna_captain',
      desc: '',
      args: [],
    );
  }
  ...
  String get pleaseDownloadtwaslna_captain {
    return Intl.message(
      'Please Download twaslna_captain',
      name: 'pleaseDownloadtwaslna_captain',
      desc: '',
      args: [],
    );
  }
