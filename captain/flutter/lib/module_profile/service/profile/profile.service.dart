...
import 'package:twaslna_captain/module_init/model/profile_post_state.dart';
import 'package:twaslna_captain/module_init/response/create_profile_response/create_profile_response.dart';
import 'package:twaslna_captain/module_orders/response/terms/terms_respons.dart';
import 'package:twaslna_captain/module_orders/service/orders/orders.service.dart';
import 'package:twaslna_captain/module_profile/manager/profile/profile.manager.dart';
import 'package:twaslna_captain/module_profile/model/activity_model/activity_model.dart';
import 'package:twaslna_captain/module_profile/model/profile_model/profile_model.dart';
import 'package:twaslna_captain/module_profile/request/profile/profile_request.dart';
import 'package:twaslna_captain/module_profile/response/profile_response.dart';
...
class ProfileService {
  ...
  Future<ProfileModel> getProfile() async {
    ...
    if (response.statusCode != '200') return ProfileModel.error(StatusCodeHelper.getStatusCodeMessages(code));
  ...
  Future<ProfilePostState> createProfile(ProfileRequest profileRequest) async {
    CreateCaptainProfileResponse? clientOrderResponse = await _manager.createCaptainProfile(profileRequest);
