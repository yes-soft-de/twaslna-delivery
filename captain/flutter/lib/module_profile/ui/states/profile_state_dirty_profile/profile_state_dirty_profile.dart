...
import 'package:twaslna_captain/module_profile/ui/widget/profile_form/profile_form.dart';
...
class ProfileStateDirtyProfile extends ProfileState {
  ...
  ProfileStateDirtyProfile(
      EditProfileScreenState screenState, this.request,{this.backToProfile = false})
      : super(screenState){
         ...
         await showDialog(context: context, builder: (_){
           return CustomAlertDialog(
             onPressed: (){
               ...
               screenState.states = ProfileStateGotProfile(screenState, request);
               screenState.refresh();
             },
