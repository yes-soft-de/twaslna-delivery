...
import 'package:twaslna_captain/module_profile/state_manager/edit_profile/edit_profile.dart';
import 'package:twaslna_captain/module_profile/ui/states/profile_loading/profile_loading.dart';
import 'package:twaslna_captain/module_profile/ui/states/profile_state/profile_state.dart';
import 'package:twaslna_captain/module_profile/ui/states/profile_state_dirty_profile/profile_state_dirty_profile.dart';
import 'package:twaslna_captain/module_profile/ui/states/profile_state_got_profile/profile_state_got_profile.dart';
...
class EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar:states is ProfileStateDirtyProfile ? null :CustomTwaslnaAppBar.appBar(context, title: S.of(context).profile,),
