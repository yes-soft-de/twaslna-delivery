          ...
          child: Padding(
            ...
            child: Flex(
              ...
              children: [
                ...
                orderType != 3 && orderStatus == null ?  Flex(
                  direction: Axis.horizontal,
                  children: [
                    Flex(
                      direction: Axis.vertical,
                ...
                // divider
                orderType != 3 && orderStatus == null ? Padding(
                  padding: const EdgeInsets.only(bottom: 8.0, top: 8.0),
                  child: Divider(
                    color: Colors.grey[400]?.withOpacity(0.3),
                    thickness: 2,
               ...
               orderStatus != null && acceptedOrder ? Flex(
                 direction: Axis.horizontal,
                 ...
                 children: [
                   Text(S.of(context).orderStatus,
                       style: TextStyle(fontSize: 14)),
                   Padding(
                     padding:Localizations.localeOf(context).languageCode == 'ar' ? EdgeInsets.only(left: 20.0) : EdgeInsets.only(right: 20.0),
                     child: Text(StatusHelper.getOrderStatusMessages(orderStatus),
                       style: TextStyle(
                           fontSize: 15,
                           fontWeight: FontWeight.bold,
                           color: Theme.of(context).disabledColor),
                    ...
                    Flex(
                      ...
                      children: [
                        Text(S.of(context).distance,
                            style: TextStyle(fontSize: 14)),
                        Container(height: 4,),
                        Text(orderDestination != null ?
                          '${orderDestination} ${S.of(context).km}':S.of(context).unknown,
                          style: TextStyle(
                              fontSize: 15,
                              fontWeight: FontWeight.bold,
                              color: Theme.of(context).disabledColor),
