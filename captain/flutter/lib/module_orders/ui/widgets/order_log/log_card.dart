...
class OrderLogsCard extends StatelessWidget {
  ...
  OrderLogsCard({required this.orderId,required this.orderStatus,required this.orderDate,this.orderCost = '0',this.completeTime});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: (){
          Navigator.pushNamed(context,OrdersRoutes.ORDER_STATUS_SCREEN,arguments:orderId);
        },
        child: Container(
