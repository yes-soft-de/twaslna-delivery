...
class OrderChip extends StatefulWidget {
  ...
  final int productID;
  OrderChip({
    required this.title,required this.productID,required this.image,required this.price,this.currency = 'SAR',this.defaultQuantity = 0});
  @override
                  ...
                  Container(
                    ...
                    child:Center(
                      child: Padding(
                        ...
                        child: Text(widget.defaultQuantity.toString(),style: TextStyle(fontWeight: FontWeight.bold),),
                      ),
                    ),
                  ),
                ],
