...
class InvoiceDialog extends StatefulWidget {
  ...
  InvoiceDialog(this._controller, this.imagePath,{required this.onPressed});
              ...
              children: [
                Padding(
                  ...
                  child: ListTile(
                    ...
                    title:Text(S.current.totalBillCostHint,style: TextStyle(color: Colors.white,fontSize: 13),),
                  ),
                ),
                ClipRRect(
                    borderRadius: BorderRadius.circular(10),
