...
class CustomStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.all(currentIndex >= StatusHelper.getOrderStatusIndex(status)?18.0:14),
        child:Text('${StatusHelper.getOrderStatusIndex(status) + 1}',style: TextStyle(
          color: Colors.white,
          fontSize:22,
        ),),
      ) ,
