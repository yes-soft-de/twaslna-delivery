...
import 'package:twaslna_captain/module_orders/ui/screens/update/update.dart';
...
class OrdersModule extends YesModule {
  ...
  OrdersModule(this._orderStatus,
      this._captainOrdersScreen, this._updateScreen,this._termsScreen,this._orderLogsScreen) {
