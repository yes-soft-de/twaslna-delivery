...
import 'package:twaslna_captain/module_orders/response/order_details/order_details_response.dart';
...
class OrderRepository {
 ...
 /////////////////////////////////////////////////////
  ...
  Future<OrderActionResponse?> updateOrderState(UpdateOrderRequest request) async {
    var token = await _authService.getToken();
    ...
    return OrderActionResponse.fromJson(response,Urls.CAPTAIN_ORDER_UPDATE_API);
  }
  Future<OrderActionResponse?> updateOrderBill(OrderInvoiceRequest request) async {
    var token = await _authService.getToken();
    dynamic response = await _apiClient.put(
