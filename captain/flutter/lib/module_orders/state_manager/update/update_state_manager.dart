...
import 'package:twaslna_captain/module_orders/ui/state/update/update_state.dart';
@injectable
class UpdateStateManager {
  final OrdersService _ordersService;
  UpdateStateManager(this._ordersService);
  final PublishSubject<UpdateListState> _updateStateSubject = PublishSubject<UpdateListState>();
