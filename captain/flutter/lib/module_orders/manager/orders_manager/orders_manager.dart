...
class OrdersManager {
  ...
  Future<OrderStatusResponse?> getOrderDetails(int orderId) => _repository.getOrderDetails(orderId);
  ...
  Future<AcceptOrderResponse?> getCaptainOrders() => _repository.getCaptainOrders();
