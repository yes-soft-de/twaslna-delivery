...
class OrderModel {
  ...
  bool disableOrder(Data element, List<Branches>? sortedBranches,LatLng? initLocation) {
    ...
    if  (element.orderType != 3 && sortedBranches != null && (sortedBranches.first.distance ?? 0) > 5500)
    {
      return false;
    } if(element.orderType == 3 && element.source != null && initLocation != null && _getDestination(initLocation, element.source)! > 5500){
      return false;
    }
    return true;
  }
