...
import 'package:twaslna_captain/module_auth/exceptions/auth_exception.dart';
import 'package:twaslna_captain/module_auth/manager/auth_manager/auth_manager.dart';
import 'package:twaslna_captain/module_auth/presistance/auth_prefs_helper.dart';
import 'package:twaslna_captain/module_auth/request/login_request/login_request.dart';
import 'package:twaslna_captain/module_auth/request/register_request/register_request.dart';
import 'package:twaslna_captain/module_auth/response/login_response/login_response.dart';
import 'package:rxdart/rxdart.dart';
import 'package:twaslna_captain/module_auth/response/regester_response/regester_response.dart';
...
class AuthService {
  ...
  Future<void> loginApi(String username, String password) async {
    ...
    RegisterResponse? response = await _authManager.userTypeCheck('ROLE_CAPTAIN', loginResult.token??'');
