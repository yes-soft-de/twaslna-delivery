...
import 'package:twaslna_captain/module_profile/profile_routes.dart';
          ...
          child: Column(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: CustomNetworkImage(
                      ...
                      imageSource:profileModel.image??'https://www.pngitem.com/pimgs/m/421-4212617_person-placeholder-image-transparent-hd-png-download.png',
              ...
              ListTile(
                onTap: () {
                  Navigator.of(context)
                      .pushNamed(PlanRoutes.PLAN_ROUTE);
                },
              ...
              ListTile(
                onTap: () {
                  Navigator.of(context)
                      .pushNamed(OrdersRoutes.ORDER_LOGS);
                },
