...
class PlanScreenStateError extends PlanState {
  ...
  Widget getUI(BuildContext context) {
    ...
    if (errs.length > 1) {
      return Scaffold(
        appBar: CustomTwaslnaAppBar.appBar(context, title: S.of(context).home,
    ...
    return Scaffold(
      appBar: CustomTwaslnaAppBar.appBar(context, title: S.of(context).home,icon: Icons.sort_rounded,buttonBackground: Colors.red),
      body: ErrorStateWidget(
        onRefresh: () {
          screenState.getAccount();
        },
