...
import 'package:twaslna_captain/module_plan/state_manager/plan_screen_state_manager.dart';
import 'package:twaslna_captain/module_plan/ui/state/plan_state.dart';
import 'package:twaslna_captain/module_plan/ui/state/plan_state_loading.dart';
...
class PlanScreenState extends State<PlanScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:_currentState is PlanScreenStateError? null : CustomTwaslnaAppBar.appBar(context, title:S.current.myBalance),
