...
import 'package:twaslna_dashboard/module_reports/manager/reports_manager.dart';
...
class ReportsService {
  ...
  Future<DataModel> getCaptainsReport() async {
    ...
    ReportsCaptainResponse? _reportCaptainResponse = await _reportManager.getCaptainsReport();
    if (_reportCaptainResponse == null) {
      return DataModel.withError(S.current.networkError);
    }
    if (_reportCaptainResponse.statusCode != '200') {
      return DataModel.withError(
          StatusCodeHelper.getStatusCodeMessages(_reportCaptainResponse.statusCode));
    }
  ...
  Future<DataModel> getClientsReport() async {
    ...
    ReportsClientResponse? _reportClientResponse = await _reportManager.getClientReport();
    if (_reportClientResponse == null) {
      return DataModel.withError(S.current.networkError);
    }
    if (_reportClientResponse.statusCode != '200') {
      return DataModel.withError(
          StatusCodeHelper.getStatusCodeMessages(_reportClientResponse.statusCode));
    }
  ...
  Future<DataModel> getStoresReport() async {
    ...
    ReportsStoreResponse? _storeReportResponse = await _reportManager.getStoresReport();
    if (_storeReportResponse == null) {
      return DataModel.withError(S.current.networkError);
    }
    if (_storeReportResponse.statusCode != '200') {
      return DataModel.withError(
          StatusCodeHelper.getStatusCodeMessages(_storeReportResponse.statusCode));
    }
  ...
  Future<DataModel> getProductsReport() async {
    ...
    ReportsProductsResponse? _reportProductsResponse = await _reportManager.getProductsReport();
    if (_reportProductsResponse == null) {
      return DataModel.withError(S.current.networkError);
    }
    if (_reportProductsResponse.statusCode != '200') {
      return DataModel.withError(
          StatusCodeHelper.getStatusCodeMessages(_reportProductsResponse.statusCode));
    }
