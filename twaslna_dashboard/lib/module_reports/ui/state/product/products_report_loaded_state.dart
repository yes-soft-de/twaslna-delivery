...
class ProductsReportLoadedState extends States {
  final ProductsReportScreenState screenState;
  final String? error;
  final bool empty;
  final List<ProductsReportModel>? model;

  ProductsReportLoadedState(this.screenState, this.model,
        ...
        child: Container(color: Theme.of(context).backgroundColor,
          child: Flex(
            ...
            children: [
              ...
              SizedBox(
                  width: 200,
                  child: Text('${S.current.productOrdered} ${element.productName}')),
              Spacer(flex: 1,),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Icon(FontAwesomeIcons.shoppingCart,color: Theme.of(context).disabledColor,size: 18,),
                    ),
                    Container(
                        width: 30,
                        height: 30,
