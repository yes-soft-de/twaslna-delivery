...
class CaptainsReportLoadedState extends States {
  final CaptainsReportScreenState screenState;
  final String? error;
  final bool empty;
  final List<CaptainsReportModel>? model;

  CaptainsReportLoadedState(this.screenState, this.model,
        ...
        child: Container(color: Theme.of(context).backgroundColor,
          child: Flex(
            ...
            children: [
              ...
              SizedBox(
                  width: 200,
                  child: Text('${S.current.captainDid} ${element.captainName} ${S.current.captainDelivered}')),
              Spacer(flex: 1,),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Row(
