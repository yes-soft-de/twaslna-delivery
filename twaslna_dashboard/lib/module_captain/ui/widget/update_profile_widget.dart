...
class UpdateProfile extends StatefulWidget {
  ...
  final String? bounce;
  final String? status;
  UpdateProfile({required this.updateProfile,this.bounce,this.salary,this.status});
    ...
    return StackedForm(
        child: Form(
          ...
          child: CustomListView.custom(
            ...
            Padding(
              ...
              child: Text(S.current.salary,style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.start,),
            ),
            CustomFormField(
              ...
              hintText: S.current.salary,
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 12.0,bottom: 8,right: 12,top: 16.0),
                  child: Text(S.current.bounce,style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.start,),
                ),
                CustomFormField(
                ...
                Padding(
                  ...
                  child: ListTileSwitch(
                    switchActiveColor: Colors.green,
                      ...
                      value:status == 'active', onChanged:(v){
                    if (v){
                      status = 'active';
                      setState(() {
                      });
        ...
        onTap: () {
          if (_salaryController.text.isNotEmpty) {
            widget.updateProfile(_salaryController.text , _bounceController.text ,status.toString());
          } else {
