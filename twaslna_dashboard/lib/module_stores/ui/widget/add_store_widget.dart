...
import 'package:twaslna_dashboard/utils/components/map.dart';
...
class _AddStoreWidgetState extends State<AddStoreWidget> {
  ...
  Widget build(BuildContext context) {
    return StackedForm(
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(25),
                        color:storeLocation == null ? Theme.of(context).primaryColor : Colors.green,
                      ),
                      child: Center(
                        child: Padding(
        ...
        onTap: () {
          if (_key.currentState!.validate() && imagePath != null && storeLocation != null) {
            widget.addStore(
                catId.toString(),
                _nameController.text.trim(),
                _phoneController.text.trim(),
                imagePath!,
                GeoJson(lat:storeLocation?.latitude , long: storeLocation?.longitude),
                products,
                privateOrder);
