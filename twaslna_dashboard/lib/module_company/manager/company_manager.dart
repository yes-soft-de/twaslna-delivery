...
class CompanyManager {
  ...
  Future<ActionResponse?> createDeliveryPrice(DeliveryCompanyFinancialRequest request) =>
      _companyRepository.updateFinancialDeliveryPriceCompany(request, true);

  Future<ActionResponse?> updateDeliveryPrice(DeliveryCompanyFinancialRequest request) =>
