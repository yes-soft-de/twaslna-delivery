...
class StoresFilterModel extends DataModel {
  ...
  StoresFilterModel({required this.id, required this.storeOwnerName,required this.categoryId,
    required this.phone,required this.image, required this.privateOrders,
