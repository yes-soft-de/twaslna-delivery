...
final OrderTimLineScreen _orderTimLineScreen;
  OrdersModule(this._myOrdersScreen,this._orderDetailsScreen,this._onGoingOrdersScreen,this._orderTimLineScreen){
  ...
  Map<String, WidgetBuilder> getRoutes() {
    return {
      ...
      OrdersRoutes.ORDER_TIME_LINE : (context) => _orderTimLineScreen
    };
  }
}