            ...
            child:Row(
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(25),
                    color: element.remainingAmountForCaptain! > 0 ?Colors.green:Colors.red
                  ),
                  child:Padding(
                    padding: const EdgeInsets.only(top:8,bottom: 8,left: 16.0,right: 16),
                    child: Text(element.remainingAmountForCaptain.toString() +' '+S.current.sar,style: TextStyle(color: Colors.white),),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
