...
class LogCard extends StatelessWidget {
  ...
  LogCard({required this.orderId,required this.orderStatus,required this.orderDate,this.orderCost = '0',this.completeTime,required this.orderType,required this.deliverPrice});
