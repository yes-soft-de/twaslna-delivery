...
import 'package:twaslna_delivery/module_orders/ui/state/order_logs_state/order_logs_empty_state.dart';
import 'package:twaslna_delivery/module_orders/ui/state/order_logs_state/order_logs_error_state.dart';
import 'package:twaslna_delivery/module_orders/ui/state/order_logs_state/order_logs_loaded_state.dart';
import 'package:twaslna_delivery/module_orders/ui/state/order_logs_state/order_logs_loading_state.dart';
...
class OrderLogsStateManager {
  ...
  void getOrdersLogs(OrderLogsScreenState screenState) {
      ...
      _myOrdersService.getOrdersLogs().then((value) {
        if (value.hasError) {
          _stateSubject.add(OrderLogsErrorState(
