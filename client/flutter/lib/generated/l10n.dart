...
class S {
  ...
  /// `Welcome to twaslna_delivery`
  String get welcomeTotwaslna_delivery {
    return Intl.message(
      'Welcome to twaslna_delivery',
      name: 'welcomeTotwaslna_delivery',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Please Download twaslna_delivery`
  String get pleaseDownloadtwaslna_delivery {
    return Intl.message(
      'Please Download twaslna_delivery',
      name: 'pleaseDownloadtwaslna_delivery',
      desc: '',
      args: [],
    );
  }
