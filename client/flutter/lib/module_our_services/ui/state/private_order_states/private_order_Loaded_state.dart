...
import 'package:twaslna_delivery/module_our_services/ui/widget/custom_private_order_app_bar.dart';
          ...
          child: MakeOrderButton(
            onPressed: () {
              if (_privateOrder.currentState!.validate()){
                ...
                CustomFlushBarHelper.createError(title:S.of(context).warnning, message:S.of(context).pleaseCompleteTheForm)..show(context);
              }
            },
