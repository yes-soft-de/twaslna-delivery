...
import 'package:twaslna_delivery/module_our_services/ui/state/send_it_states/send_it_choose_destination_point.dart';
import 'package:twaslna_delivery/module_our_services/ui/state/send_it_states/send_it_choose_receipt_point.dart';
                        ...
                        child: MakeOrderButton(
                          ...
                          onPressed: () {
                            if (screenState.receiptPoint == null) {
                              ...
                              screenState.request.destination =
                                  GeoJson(lat: screenState.destinationPoint?.latitude,long: screenState.destinationPoint?.longitude);
                              screenState.request.source =
                                  GeoJson(lat: screenState.receiptPoint?.latitude,long: screenState.receiptPoint?.longitude);
