...
class StoreListErrorState extends StoreListState {
  ...
  int id;
  StoreListErrorState(this.screenState, this.error,this.id) : super(screenState);

  @override
  Widget getUI(BuildContext context) {
    return Scaffold(
      appBar: CustomTwaslnaAppBar.appBar(context, title:S.of(context).categories,buttonBackground:Colors.red),
