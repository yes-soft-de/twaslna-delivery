...
class NotificationModel {
  ...
  NotificationModel({required this.orderNumber,required this.title,required this.body,required this.date});
  ...
  NotificationModel.Data(MyNotificationResponse orders) {
    ...
    data?.forEach((element) {
      String notificationDate = DateFormat.jm().format(DateTime.fromMillisecondsSinceEpoch(
