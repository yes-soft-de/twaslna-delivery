...
import 'package:twaslna_delivery/module_my_notifications/ui/state/my_notifications/my_notification_empty_state.dart';
import 'package:twaslna_delivery/module_my_notifications/ui/state/my_notifications/my_notifications_error_state.dart';
    ...
    if (_authService.isLoggedIn) {
      ...
      _myNotificationsService.getNotification().then((value) {
        if (value.hasError) {
          ...
          _stateSubject
              .add(MyNotificationsEmptyState(screenState, S.current.homeDataEmpty));
        } else {
          _stateSubject.add(MyNotificationsLoadedState(screenState, value.data));
        }
      });
    } else {
